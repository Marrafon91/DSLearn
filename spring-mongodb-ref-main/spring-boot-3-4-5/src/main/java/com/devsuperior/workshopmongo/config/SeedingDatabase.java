...
public class SeedingDatabase {
    ...
    public CommandLineRunner init(
        ...
        return args -> {
            ...
            Flux<User> insertedUsers = userRepository.saveAll(Arrays.asList(maria, alex, bob));
            insertedUsers.subscribe();
            ...
            Flux<Post> insertedPosts = postRepository.saveAll(Arrays.asList(post1, post2));
            insertedPosts.subscribe();
